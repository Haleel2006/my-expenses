...
export default function SettingsPage() {
  ...
  const handleTogglePin = async () => {
    ...
    if (newEnabled) {
      ...
      try {
        ...
        toast({ title: "Error updating security", description: error.message, variant: "destructive" });
      }
    }
  };
  ...
  const handleSavePin = async () => {
    ...
    try {
      ...
      const error = err as Error;
      toast({ title: "Error saving PIN", description: error.message, variant: "destructive" });
    }
  };
